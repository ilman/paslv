		...
		switch($field_type) {
			...
			case 'select':  
				...
				foreach ($field_options as $option) { 
					...
					$output .= '<option value="'.$option_value.'" '.self::input_checked($value, $option_value, 'selected').'>'.$option_label.'</option>';  
				}  
				$output .= '</select> ';  
			break; 
			...
			case 'multicheckbox':
				foreach ($field_options as $option) { 
					...
					$output .= '<div class="'.$this_class.'"><label><input type="checkbox" name="'.$field_name.'[]" id="'.$this_id.'" value="'.$option['value'].'" '.self::input_checked($value, $option['value']).' /> '.$option['label'].'</label></div>';  
				}  
			break;
