	...
	<div id="print-page-header">
		<table class="table-full">
			<tr>
				<th colspan="2">&nbsp;</th>
				<th width="33%">
					<h2 class="hidden-print">Kwitansi</h2>
					<div class="box box-sm">
						<span class="key">No.</span>
						<span class="val">
							<?php 
								$kwitansi_number = SG_Util::val($values, 'kwitansi_number');
								echo ($kwitansi_number) ? $kwitansi_number : '-';
							?>
						</span>
					</div>
					<div class="box box-sm">
						...
						<span class="val">
							<?php 
								$kwitansi_date = strtotime(SG_Util::val($values, 'created_at'));
								echo ($kwitansi_date) ? date('j F Y', $kwitansi_date) : date('j F Y');
							?>
						</span>
					</div>
				</th>
			...
			<tr>
				<td>
					...
					<span class="box shade">
						<?php 
							$kwitansi_amount_text = SG_Util::val($values, 'kwitansi_amount_text');
							echo ($kwitansi_amount_text) ? $kwitansi_amount_text : '-';
						?>
					</span>
				</td>
			</tr>
			<tr>
				<td>
					<div class="box" id="box-content">
						...
						<?php echo SG_Util::val($values, 'kwitansi_text') ?>
					</div>
				</td>
			</tr>
		</table>
		...
		<table class="table-full">
			<tr>
				<td width="40%">
					...
					<span class="box shade"><?php echo SG_Util::val($values, 'kwitansi_amount') ?></span>
				</td>
				<td>&nbsp;</td>
