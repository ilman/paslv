	...
	<div class="col-sm-6">
		<div class="form-group">
			...
			<div class="input-group">
				...
				<?php 
					$contract_id = SG_Util::val($values, 'id');
					$contract_number = 'INV/PAS/2014/'.$contract_id;
				?>
				<?php echo SG_Form::field('text', 'contract_number', $contract_number, $attr); ?>
			</div>
		</div>			
	</div>
	<!-- col -->
...
<?php echo SG_Form::field('hidden', 'contract_id', $contract_id); ?>